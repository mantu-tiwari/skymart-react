...
const ProductCard = ({ product }) => {
  return (
    <div className="bg-[#111111] border border-zinc-800 rounded-2xl overflow-hidden hover:border-lime-400 transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="p-4">
        <h2 className="text-white font-semibold line-clamp-2 min-h-[55px]">
          {product.title}
        </h2>
        ...
        <div className="flex justify-between items-center mt-5">
          ...
          <button className="bg-lime-400 hover:bg-lime-300 text-black px-4 py-2 rounded-full text-sm font-semibold transition">
